...
import { Sparkles, MessageCircle, Code2, Briefcase, Mail } from 'lucide-react';
...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-900 dark:bg-dark-950 text-gray-400">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              Turn any study material into smart notes in seconds with AI. Trusted by 100,000+ students worldwide.
            </p>
